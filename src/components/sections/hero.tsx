    ...
    return (
        ...
        >
            <div className='md:w-1/2 w-3/4 mx-5'>
                <h1 className='mt-4 text-dark-black xl:text-4xl lg:text-3xl md:text-2xl text-xl font-lexendExa'>
                    Hi there, my name is
                </h1>
                <h2 className='mt-1 text-primary xl:text-5xl lg:text-4xl md:text-3xl text-2xl font-lexendExa'>
                    Sophia Wu.
                </h2>
                <p className='mt-3 mb-6 text-off-black xl:text-xl text-lg font-light font-lexend'>
                ...
                <a className="relative inline-flex items-center justify-start inline-block px-5 py-3 overflow-hidden font-semibold rounded-full group shadow-btn"
                    ...
                    <span className="relative w-full text-left text-dark-black font-lexendExa transition-colors duration-700 ease-in-out group-hover:text-off-white">Let's Connect!</span>
